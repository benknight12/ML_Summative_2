...
n=1
dataset <- cbind(methylation[,c((1+n*100000):((n+1)*100000))],pfi =methylation[,"pfi"])
...
saveRDS(processed_df,paste0("../../preprocessed/MethData_following_feature_selection/TrimData_",n,".Rda"))
